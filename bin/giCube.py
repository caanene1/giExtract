...
parser.add_argument('-f', '--format', type=str, required=True, default=".jpg",
                    help="Image format to load and extract")

parser.add_argument('-d', '--dimension', type=int, required=True, default=300,
...
parser.add_argument('-t', '--tolerance', type=int, required=False, default=20,
